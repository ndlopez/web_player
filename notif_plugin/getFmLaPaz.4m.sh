...
# <xbar.image>https://github.com/ndlopez/weather_app/raw/notif/notif_app/currWeather_1h_prev.png</xbar.image>
# <xbar.dependencies>bash,curl,tr,cut</xbar.dependencies>
